resource "digitalocean_droplet" "swarm-manager-1" {
...
resource "digitalocean_droplet" "swarm-manager-2" {
  image = "${var.swarm_snapshot_id}"
  size = "${var.swarm_instance_size}"
...
resource "digitalocean_droplet" "swarm-manager-3" {
  image = "${var.swarm_snapshot_id}"
  size = "${var.swarm_instance_size}"
...
output "swarm_manager_3_public_ip" {
  value = "${digitalocean_droplet.swarm-manager-3.ipv4_address}"
}

output "swarm_manager_3_private_ip" {
  value = "${digitalocean_droplet.swarm-manager-3.ipv4_address_private}"
}
