...
|usersSecret  |Name of file prefixed /run/secrets/dfp_users_%s from which credentials will be taken for this service. /run/secrets/dfp_users_* files must be a comma-separated list of credentials(<user>:<pass>) |No| |monitoring|
